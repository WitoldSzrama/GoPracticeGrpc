...
type BookServiceClient interface {
	...
	GetAuthorBooks(ctx context.Context, in *GetAuthorBooksRequest, opts ...grpc.CallOption) (*BooksResponse, error)
}
...
func (c *bookServiceClient) GetAuthorBooks(ctx context.Context, in *GetAuthorBooksRequest, opts ...grpc.CallOption) (*BooksResponse, error) {
	out := new(BooksResponse)
	err := c.cc.Invoke(ctx, "/proto.BookService/GetAuthorBooks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	GetAuthorBooks(context.Context, *GetAuthorBooksRequest) (*BooksResponse, error)
...
func (UnimplementedBookServiceServer) GetAuthorBooks(context.Context, *GetAuthorBooksRequest) (*BooksResponse, error) {
...
func _BookService_GetAuthorBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.BookService/GetAuthorBooks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
